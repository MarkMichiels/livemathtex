...
<objective>
Fix ISS-006: Detect and error on incompatible unit operations (e.g., kg + m).
...
@.planning/ISSUES.md (ISS-006 section)

**From ISSUES.md ISS-006:**
...
<feature>
  ...
  <implementation>
    Option A from ISSUES: Pre-check dimensional compatibility
...
```python
"""Tests for ISS-006: Dimensional compatibility checking."""
import pytest
...
<task type="auto">
  ...
  <files>examples/error-handling/input.md, .planning/ISSUES.md</files>
  <action>
...
4. Update ISSUES.md:
  ...
  <done>Error-handling example updated, ISSUES.md shows ISS-006 resolved</done>
</task>
...
4. Check that existing calculations still work (multiplication, division, compatible addition)
  ...
  <done>All tests pass, Phase 2 complete (ISS-004, ISS-005, ISS-006 all resolved)</done>
</task>
