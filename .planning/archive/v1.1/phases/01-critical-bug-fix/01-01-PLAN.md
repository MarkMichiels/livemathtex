...
<objective>
Fix ISS-003: Failed variable definition must not silently fall back to unit interpretation.
...
@.planning/PROJECT.md
@.planning/ROADMAP.md
@.planning/ISSUES.md (ISS-003 section)
...
<task type="auto">
  ...
  <files>.planning/ISSUES.md, examples/README.md</files>
  <action>
    1. Update ISSUES.md ISS-003:
  ...
  <verify>grep "Resolved" .planning/ISSUES.md shows ISS-003 marked resolved</verify>
  <done>ISSUES.md updated, examples/README.md updated</done>
</task>
...
- [ ] .planning/ISSUES.md shows ISS-003 as resolved
</verification>
...
- Documentation updated (ISSUES.md, examples/README.md)
...
- `docs(01-01): add error-handling examples and update ISSUES`
