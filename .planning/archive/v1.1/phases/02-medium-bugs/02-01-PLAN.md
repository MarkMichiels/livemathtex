...
<objective>
Fix ISS-004: Directive parser should skip fenced code blocks.
...
<task type="auto">
  ...
  <action>
Create new test file `tests/test_lexer_directives.py` with tests for ISS-004:
...
```python
# Strip fenced code blocks before scanning for directives (ISS-004)
...
3. Update .planning/ISSUES.md:
  ...
  <done>All tests pass, ISSUES.md updated with ISS-004 resolution</done>
</task>
...
- [ ] ISS-004 marked resolved in ISSUES.md
</verification>
